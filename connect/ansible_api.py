...
class AnsibleAPI(object):
    ...
    def __initializeData(self):
        ...
        self.inventory = MyInventory(self.resource, self.loader).inventory
        self.variable_manager=VariableManager(inventory=self.inventory,loader=self.loader)
    ...
    def run_playbook(self, host_list, role_name, role_uuid, temp_param):
        ...
        try:
            self.callback = ResultsCollector()
            filenames = ['' + 'connect/playbook/docker.yml']  # playbook的路径
